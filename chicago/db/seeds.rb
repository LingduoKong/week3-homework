...
[
	...
	{:title => 'The Art Institute of Chicago',
	 :photo_url => 'https://www.gatewayticketing.com/Portals/0/Images/Press%20Releases/AIC-Facade-North-View.jpg',
	...
	{:title => 'Newberry Library',
	 :photo_url => 'http://publications.newberry.org/indiansofthemidwest/wp-content/gallery/aboutus270/newberry-library.jpg',
	 :admission_price => 0,
	 :description => "A world-renowned independent research library in Chicago, the Newberry offers readers an extensive noncirculating collection of rare books, maps, music, manuscripts, and other printed material spanning six centuries. Its staff provides award-winning service and supports a rich array of programmatic opportunities."
	 }
].each do |place_hash|
	p = Place.new
...
# [
# 	{"title"=>"a review", "rate"=>4, "description"=>"description", "placeid"=>46}
# ].each do |review|
# 	r = Review.new
